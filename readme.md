...
- *The ‘fed’ status of the dog will reset each day*. The dogs name & information will be assigned a ‘DoggyID’ and remain in the database until it has been deleted (adopted).
    ...
    **Menu options include:**
    ...
    3. 1. **View dogs & information (including dietary requirements/ in readable format)**
    ...
    3. 2. **Add a dog & its information to the database** 
    ...
    3. 3. **Edit dog information in database**
    ...
    3. 4. **Update the fed status of a dog**
    ...
    3. 6. **Remove a dog from the shelter**
    ...
    ***Additional notes***
    ...
    ![flowchart](/T1A3-images/t1a3_flowchart.pdf)

...
4. Once you have navigated to the folder of the application, simply type `bash run_app.sh` and the program should install the necessary package requirements and begin. 
...
4. Type `bash run_app.sh` and the program should have installed the necessary requirements and begin to run. 
